...
local ok_contracts, contracts = pcall(dofile, ROOT .. "Core/IFLS_Contracts.lua")
local ok_ext, ext           = pcall(dofile, ROOT .. "Core/IFLS_ExtState.lua")
local ok_idm_flavors, IDM_FLAVORS = pcall(dofile, ROOT .. "Domain/IFLS_IDMFlavorProfiles.lua")
...
local ok_bridge, bridge = pcall(dofile, ROOT .. "Domain/IFLS_PluginMetaBridgeDomain.lua")
...
function M.build_chain_for_idm_profile(profile_id, seed, opts)
  ...
  local bridge = nil
  local ok_bridge, b = pcall(dofile, ROOT .. "Domain/IFLS_PluginMetaBridgeDomain.lua")
